<template>
  <div>
    <el-row :gutter="20">
      <el-col :span="10">
        <el-form ref="form" :rules="rules" :model="form" size="small" label-width="80px">
          ...
          <el-form-item label="活动区域" prop="region">
            <el-select placeholder="请选择活动区域" v-model="form.region" clearable>
      ...
      <el-col :span="10">
        <el-form :rules="rules" inline label-position="top" label-width="100px">
          <el-form-item label="审批人" prop="name">
            <el-input type="text" placeholder="审批人"></el-input>
          </el-form-item>
          
          <el-form-item label="活动区域">
            <el-select v-model="form.region" placeholder="活动区域" clearable>
